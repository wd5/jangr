...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FeedPost.hash'
        db.add_column('aggregator_feedpost', 'hash', self.gf('django.db.models.fields.CharField')(default='', max_length=64), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FeedPost.hash'
        db.delete_column('aggregator_feedpost', 'hash')
