...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Feed.last_parsed'
        db.add_column('aggregator_feed', 'last_parsed', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Feed.last_parsed'
        db.delete_column('aggregator_feed', 'last_parsed')
