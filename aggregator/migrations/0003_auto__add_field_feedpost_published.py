...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FeedPost.published'
        db.add_column('aggregator_feedpost', 'published', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FeedPost.published'
        db.delete_column('aggregator_feedpost', 'published')
