...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FeedPost.relevance'
        db.add_column('aggregator_feedpost', 'relevance', self.gf('django.db.models.fields.SmallIntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FeedPost.relevance'
        db.delete_column('aggregator_feedpost', 'relevance')
