...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Feed.moderate'
        db.add_column('aggregator_feed', 'moderate', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Feed.moderate'
        db.delete_column('aggregator_feed', 'moderate')
