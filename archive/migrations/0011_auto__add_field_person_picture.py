...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('archive_person', 'picture', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Person.picture'
        db.delete_column('archive_person', 'picture')
