...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Artist.picture'
        db.add_column('archive_artist', 'picture', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Artist.picture'
        db.delete_column('archive_artist', 'picture')
