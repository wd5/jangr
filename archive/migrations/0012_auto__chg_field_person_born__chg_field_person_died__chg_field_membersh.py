...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Person.born'
        db.alter_column('archive_person', 'born', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'Person.died'
        db.alter_column('archive_person', 'died', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'Membership.since'
        db.alter_column('archive_membership', 'since', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'Membership.until'
        db.alter_column('archive_membership', 'until', self.gf('django.db.models.fields.DateField')(null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Person.born'
        raise RuntimeError("Cannot reverse this migration. 'Person.born' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Person.died'
        raise RuntimeError("Cannot reverse this migration. 'Person.died' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Membership.since'
        raise RuntimeError("Cannot reverse this migration. 'Membership.since' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Membership.until'
        raise RuntimeError("Cannot reverse this migration. 'Membership.until' and its values cannot be restored.")
