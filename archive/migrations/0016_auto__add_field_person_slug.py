...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('archive_person', 'slug', self.gf('autoslug.fields.AutoSlugField')(default='no', unique_with=(), max_length=50, populate_from=None, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Person.slug'
        db.delete_column('archive_person', 'slug')
