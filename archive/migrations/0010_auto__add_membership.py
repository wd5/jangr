...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('archive_membership', (
            ...
            ('since', self.gf('django.db.models.fields.DateField')(blank=True)),
            ('until', self.gf('django.db.models.fields.DateField')(blank=True)),
    ...
    models = {
        'archive.artist': {
            ...
            'members': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['archive.Person']", 'through': "orm['archive.Membership']", 'symmetrical': 'False'}),
        ...
        'archive.membership': {
            ...
            'since': ('django.db.models.fields.DateField', [], {'blank': 'True'}),
            'until': ('django.db.models.fields.DateField', [], {'blank': 'True'})
        },
        'archive.person': {
            'Meta': {'object_name': 'Person'},
            'born': ('django.db.models.fields.DateField', [], {'blank': 'True'}),
            'died': ('django.db.models.fields.DateField', [], {'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
