...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Album.released'
        db.alter_column('archive_album', 'released', self.gf('django.db.models.fields.DateField')(null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Album.released'
        raise RuntimeError("Cannot reverse this migration. 'Album.released' and its values cannot be restored.")
    ...
    models = {
        ...
        'archive.albumtrack': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'number': ('django.db.models.fields.PositiveSmallIntegerField', [], {'blank': 'True'}),
