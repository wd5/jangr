...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Membership.since'
        db.delete_column('archive_membership', 'since')

        # Deleting field 'Membership.until'
        db.delete_column('archive_membership', 'until')

        # Adding field 'Membership.years'
        db.add_column('archive_membership', 'years', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Membership.since'
        db.add_column('archive_membership', 'since', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)

        # Adding field 'Membership.until'
        db.add_column('archive_membership', 'until', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)

        # Deleting field 'Membership.years'
        db.delete_column('archive_membership', 'years')
