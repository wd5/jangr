...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Song.original_artist'
        db.delete_column('archive_song', 'original_artist_id')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Song.original_artist'
        db.add_column('archive_song', 'original_artist', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['archive.Artist']), keep_default=False)
