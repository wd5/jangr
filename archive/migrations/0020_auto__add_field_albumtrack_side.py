...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AlbumTrack.side'
        db.add_column('archive_albumtrack', 'side', self.gf('django.db.models.fields.CharField')(default='', max_length=1, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AlbumTrack.side'
        db.delete_column('archive_albumtrack', 'side')
