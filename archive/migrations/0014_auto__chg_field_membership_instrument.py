...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Membership.instrument'
        db.alter_column('archive_membership', 'instrument', self.gf('django.db.models.fields.CharField')(max_length=100))


    def backwards(self, orm):
        
        # Changing field 'Membership.instrument'
        db.alter_column('archive_membership', 'instrument', self.gf('django.db.models.fields.CharField')(max_length=10))
