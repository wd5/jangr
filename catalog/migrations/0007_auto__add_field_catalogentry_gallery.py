...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CatalogEntry.gallery'
        db.add_column('catalog_catalogentry', 'gallery', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['documents.DocumentAlbum'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CatalogEntry.gallery'
        db.delete_column('catalog_catalogentry', 'gallery_id')
    ...
    models = {
        ...
        'catalog.catalogentry': {
            ...
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'gallery': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['documents.DocumentAlbum']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
