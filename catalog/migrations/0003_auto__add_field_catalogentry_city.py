...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CatalogEntry.city'
        db.add_column('catalog_catalogentry', 'city', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['samodei.City'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CatalogEntry.city'
        db.delete_column('catalog_catalogentry', 'city_id')
