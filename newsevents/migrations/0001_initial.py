...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('newsevents_eventattendee', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('event', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['newsevents.Event'])),
            ('certainty', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('newsevents', ['EventAttendee'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('newsevents_eventattendee')
    ...
    models = {
        ...
        'newsevents.eventattendee': {
            'Meta': {'object_name': 'EventAttendee'},
            'certainty': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'event': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['newsevents.Event']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
