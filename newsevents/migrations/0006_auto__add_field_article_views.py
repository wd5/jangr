...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('newsevents_article', 'views', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Article.views'
        db.delete_column('newsevents_article', 'views')
